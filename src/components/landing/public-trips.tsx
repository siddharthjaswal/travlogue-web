...
export function PublicTrips({ variant = 'section' }: { variant?: 'section' | 'hero' }) {
    ...
    return (
      <div className="w-full">
        <div className="flex gap-4 overflow-x-auto pb-2 snap-x snap-mandatory">
          {trips.map((trip) => (
            <Link key={trip.id} href={`/public/trips/${trip.id}`} className="min-w-[260px] max-w-[260px] snap-start">
              <Card className="rounded-2xl overflow-hidden border-border/40 bg-card/70 shadow-md">
